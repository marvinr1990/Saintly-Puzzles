...
export const LEVELS: Record<string, LevelData> = {
  francis: {
    ...
    category: 'saint',
    imageUrl: `${base}icons/francis.jpg`,
    difficulty: 3,
  ...
  guadalupe: {
    ...
    category: 'mary',
    imageUrl: `${base}icons/guadalupe.jpg`,
    difficulty: 5,
  ...
  michael: {
    ...
    category: 'saint',
    imageUrl: `${base}icons/michael.jpg`,
    difficulty: 4,
  ...
  joseph: {
    ...
    name: 'St. Joseph',
    category: 'saint',
    imageUrl: `${base}icons/joseph.jpg`,
    difficulty: 4,
  ...
  ignatius: {
    ...
    category: 'saint',
    imageUrl: `${base}icons/ignatius.jpg`,
    difficulty: 4,
  ...
  thomas: {
    ...
    category: 'saint',
    imageUrl: `${base}icons/thomas.jpg`,
    difficulty: 4,
